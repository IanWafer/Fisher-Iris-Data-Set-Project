...
iris = pd.read_csv('input\iris.csv', header = None) #include header=None if you wish to assign column names as in the next line. I initially forgot this and ended up with my data set one line short
...
# Overview
sb.boxplot(data = iris, orient = 'h') # as per
